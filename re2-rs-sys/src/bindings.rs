...
unsafe extern "C" {
    pub fn re2_options_set_posix_syntax(o: *mut RE2Options, posix: ::std::os::raw::c_int);
}
unsafe extern "C" {
    pub fn re2_options_set_longest_match(o: *mut RE2Options, longest: ::std::os::raw::c_int);
}
unsafe extern "C" {
